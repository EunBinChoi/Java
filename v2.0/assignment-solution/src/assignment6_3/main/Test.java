package assignment6_3.main;

import assignment6_3.shape.*;
import assignment6_3.line.*;
...
//		Shape s = new Shape();
		...
		lines[0] = new LineSegment(new Point(3, 5), new Point(7, 8));
		lines[1] = new Curve(new Point(0, 0), 30);
		lines[2] = new StraightLine(new Point(0, 5), 2);

		double dist = ((LineSegment)lines[0]).calcDistance();
		System.out.println("LineSegment Distance: " + dist);

		// or
		LineSegmentControl lineSegmentControl = new LineSegment(3, 5, 1, 2);
		dist = lineSegmentControl.calcDistance();
		System.out.println("LineSegment Distance: " + dist);
